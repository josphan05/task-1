        ...
        <form action="{{ route('users.index') }}" method="GET" class="row g-3 mb-4">
            ...
            <div class="col-md-3">
                <select class="form-select" name="status">
                    ...
                    <option value="unverified" {{ request('status') == 'unverified' ? 'selected' : '' }}>Không hoạt động</option>
                </select>
            </div>
            <div class="col-md-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-1">
                                <a href="{{ route('users.show', $user) }}" class="btn btn-sm btn-info" data-coreui-toggle="tooltip" title="Xem chi tiết">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('users.edit', $user) }}" class="btn btn-sm btn-warning" data-coreui-toggle="tooltip" title="Chỉnh sửa">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <button type="button" class="btn btn-sm btn-danger" data-coreui-toggle="tooltip" title="Xóa"
